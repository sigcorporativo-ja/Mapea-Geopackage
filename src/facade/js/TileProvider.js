...
class GeoPackageTile extends AbstractProvider {
  constructor(connector, tableName, options) {
     ...
     * @type {number}
     */
    this.tileWidth_ = M.utils.isNumber(this.options_.width) ? this.options_.width : 256;
     ...
     * @type {number}
     */
    this.tileHeight_ = M.utils.isNumber(this.options_.height) ? this.options_.height : 256;
  }
